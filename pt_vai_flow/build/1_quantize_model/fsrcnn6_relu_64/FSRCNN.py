...
class FSRCNN(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_13 = py_nndct.nn.Conv2d(in_channels=16, out_channels=56, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #FSRCNN::FSRCNN/Sequential[expanding]/Conv2d[0]/ret.27(FSRCNN::nndct_conv2d_13)
        self.module_14 = py_nndct.nn.ReLU(inplace=False) #FSRCNN::FSRCNN/Sequential[expanding]/ReLU[1]/ret.29(FSRCNN::nndct_relu_14)
        self.module_15 = py_nndct.nn.ConvTranspose2d(in_channels=56, out_channels=3, kernel_size=[9, 9], stride=[2, 2], padding=[4, 4], output_padding=[1, 1], groups=1, bias=True, dilation=[1, 1]) #FSRCNN::FSRCNN/ConvTranspose2d[deconvolution]/ret(FSRCNN::nndct_conv_transpose_2d_15)
