...
def main(args):
    ...
    q_aware_model.save('sr7_dataset/input_model/' + training_parameters['model_name'] + '.h5')
    
if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_path', default="sr7_dataset/train/", type=str, help='Path to the dataset')
