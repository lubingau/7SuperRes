...
python create_dataset.py --input_dir /path/to/input_images --output_dir sr7_dataset/train/ --kernel_path blur_kernel.csv --stride 0.75 --patch_size 256 --nb_img -1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='sr7_dataset/train/', type=str, help='Path to save the dataset')
